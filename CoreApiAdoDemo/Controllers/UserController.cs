...
namespace CoreApiAdoDemo.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        [HttpGet]
        [Route("GetCreadentialData")]
        public IActionResult GetCreadentialData([FromBody]UsersModel model)
        {
            var data = DbClientFactory<UserDbClient>.Instance.GetCreadentialData(model, appSettings.Value.DbConn);
            return Ok(data);
        }
